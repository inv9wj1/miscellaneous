...
router.get('/getFileSpaceData', async (req, res) => {
    ...
    try {
        ...
        let response = "[{\"id\": \"0\",\"name\": \"Root\",\"isDir\": true,\"files\": [  {\"id\": \"1\",\"name\": \"Folder 1\",\"isDir\": true,\"files\": [{  \"id\": \"11\",  \"name\": \"Sub Folder 1\",  \"isDir\": true,  \"files\": [{\"id\": \"111\",\"name\": \"Sub Folder 2\",\"isDir\": true,\"files\": [  {\"id\": \"1111\",\"name\": \"job1.txt\"  },  {\"id\": \"1112\",\"name\": \"job2.txt\"  }]}  ]}]  },  { \"id\": \"2\", \"name\": \"Folder 2\", \"isDir\": true },  { \"id\": \"3\", \"name\": \"Folder 3\", \"isDir\": true }]}  ]  ";
       // response = "[ { \"id\": \"1\", \"name\": \"SYSSHR.ZOOPS.CLIST\", \"isDir\": true, \"files\": [ { \"id\": \"11\", \"name\": \"FILESPAC.txt\" }, { \"id\": \"12\", \"name\": \"FILESPV3.txt\" }, { \"id\": \"13\", \"name\": \"FILESPV5.txt\" }, { \"id\": \"14\", \"name\": \"FILSPAV1.txt\" }, { \"id\": \"15\", \"name\": \"FILSPAV2.txt\" }, { \"id\": \"16\", \"name\": \"JFILE.txt\" }, { \"id\": \"17\", \"name\": \"JMONIT.txt\" }, { \"id\": \"18\", \"name\": \"JMONITV2.txt\" }, { \"id\": \"19\", \"name\": \"JMONITV3.txt\" }, { \"id\": \"110\", \"name\": \"JMONITV4.txt\" }, { \"id\": \"111\", \"name\": \"JMONITV5.txt\" }, { \"id\": \"112\", \"name\": \"JSONV1.txt\" }, { \"id\": \"113\", \"name\": \"SOOPS.txt\" }, { \"id\": \"114\", \"name\": \"SOOPSV2.txt\" }, { \"id\": \"115\", \"name\": \"TEST.txt\" }, { \"id\": \"116\", \"name\": \"TEST2.txt\" }, { \"id\": \"117\", \"name\": \"TEST3.txt\" }, { \"id\": \"118\", \"name\": \"TEST4.txt\" }, { \"id\": \"119\", \"name\": \"TEST5.txt\" }, { \"id\": \"120\", \"name\": \"TEST6.txt\" }, { \"id\": \"121\", \"name\": \"TODO.txt\" }, { \"id\": \"122\", \"name\": \"UPDCPU.txt\" } ] }, { \"id\": \"2\", \"name\": \"SYSSHR.ZOOPS.FILES\", \"isDir\": true, \"files\": [ { \"id\": \"21\", \"name\": \"CPUPER.txt\" }, { \"id\": \"22\", \"name\": \"FILES.txt\" }, { \"id\": \"23\", \"name\": \"FILES1.txt\" }, { \"id\": \"24\", \"name\": \"FILSPACE.txt\" }, { \"id\": \"25\", \"name\": \"HLTHCHK.txt\" }, { \"id\": \"26\", \"name\": \"SAMPLE.txt\" }, { \"id\": \"27\", \"name\": \"SAMPLE1.txt\" }, { \"id\": \"28\", \"name\": \"SMFPER.txt\" }, { \"id\": \"29\", \"name\": \"SPOOLPER.txt\" }, { \"id\": \"210\", \"name\": \"WTOR.txt\" } ] }, { \"id\": \"3\", \"name\": \"SYSSHR.ZOOPS.TEST\", \"isDir\": true, \"files\": [ { \"id\": \"31\", \"name\": \"CPUPER.txt\" }, { \"id\": \"32\", \"name\": \"FILES.txt\" } ] } ]";
        console.log("original response --------------------------------------------------");
        console.log(response)
        console.log("original response --------------------------------------------------");
       // if (response && response.success) {
            if (response) {
            let responseStr = response ; //response.commandResponse;
            console.log("responseStr --------------------------------------------------");
            console.log(responseStr);
            console.log("responseStr --------------------------------------------------");
            if (!responseStr || responseStr.length == 0) {
